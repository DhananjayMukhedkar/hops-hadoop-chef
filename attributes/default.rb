...
default['hops']['docker']['testconnector']['download_url'] = "https://repo.hops.works/dev/dhananjay/testconnector/#{node['hops']['docker']['testconnector']['image']['version']}/testconnector.tgz"